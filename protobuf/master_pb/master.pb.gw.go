...
/*
Package master_pb is a reverse proxy.
...
func request_Master_GetStorageStatus_0(ctx context.Context, marshaler runtime.Marshaler, client MasterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Master_GetStorageStatus_0(ctx context.Context, marshaler runtime.Marshaler, server MasterServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetStorageStatusRequest
	var metadata runtime.ServerMetadata
...
func RegisterMasterHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MasterServer) error {
	...
	mux.Handle("GET", pattern_Master_GetStorageStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/master.Master/GetStorageStatus", runtime.WithHTTPPathPattern("/StorageStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Master_GetStorageStatus_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Master_GetStorageStatus_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMasterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MasterClient) error {
	...
	mux.Handle("GET", pattern_Master_GetStorageStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/master.Master/GetStorageStatus", runtime.WithHTTPPathPattern("/StorageStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Master_GetStorageStatus_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Master_GetStorageStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"StorageStatus"}, ""))
)

var (
	forward_Master_GetStorageStatus_0 = runtime.ForwardResponseMessage
)
